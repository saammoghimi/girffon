document.addEventListener("DOMContentLoaded", function () {
  ...
  function sectionName(section) {
    ...
    if (fixedName) {
      const titleNode = section.querySelector(".gx25-men-title");
      if (titleNode) {
    ...
    const title = section.querySelector(".gx25-men-title") || section.querySelector(".gx25-title-main");
    return (title ? title.textContent : "Collection").trim();
  }
    ...
    return (
      '<article class="gx25-card" data-product-id="' + product.id + '" data-section-name="' + product.sectionName + '" data-base-title="' + product.baseTitle + '" data-price-eur="' + product.priceEur + '">' +
        ...
        '<div class="gx25-image-box">' +
          ...
          '<img class="gx25-main-image" src="' + defaultImages[0] + '" alt="' + product.title + '">' +
