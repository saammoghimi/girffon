...
$areaNotes = [
    ...
    'new-arrivals' => 'Number of New Arrivals product cards',
          ...
          <article class="admin-panel">
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="mobile-form">
                <?php if ($area === 'new-arrivals'): ?>
                <input type="hidden" name="display_order" value="<?php echo (int) ($selected['display_order'] ?? 170); ?>">
                <label class="mobile-wide">New Arrivals product limit<input type="number" name="settings[product_limit]" min="1" step="1" required value="<?php echo girffonMobileAdminEscape($settings['product_limit'] ?? ''); ?>" placeholder="Example: 60"></label>
                <?php else: ?>
                <?php if ($area === 'category-buttons'): ?><label>Button name<input type="text" name="section_name" required maxlength="120" value="<?php echo girffonMobileAdminEscape($selectedEntryName); ?>" placeholder="Example: Animation or Animals"></label><label>Fixed HOME slot<input type="text" value="<?php echo (int) ($definitions[$selectedKey]['slot'] ?? 0); ?>" readonly></label><?php endif; ?>
